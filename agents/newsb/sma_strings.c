...
static struct _sma_string {
	...
	{ 1038, "Manual cos φ specification" },
	{ 1039, "cos φ setpoint for active power output" },
	{ 1040, "Excitation type for active power output" },
	{ 1041, "Overexcited" },
	{ 1042, "Underexcited" },
	{ 1043, "cos φ(P) charac. curve" },
	{ 1044, "Excitation type at starting point" },
	{ 1045, "cos φ of start point" },
	{ 1046, "Excitation type at end point" },
	{ 1047, "cos φ of end point" },
	...
	{ 1074, "cos φ, manual setting" },
	{ 1075, "cos φ, external setting" },
	{ 1076, "cos φ(P) charac. curve" },
	...
	{ 1194, "cos φ config. method of PV system control" },
	...
	{ 1970, "cos φ spec.: |f0| (|x9|-|x8|-|x7|-|x6|-|x5|-|x4|)" },
	...
	{ 2482, "cos φ of start point" },
	{ 2483, "cos φ of end point" },
	...
	{ 2504, "Fallback value of cos φ for active power output" },
	...
	{ 2635, "1st stage with 2-stage load shedding" },
	{ 2636, "Timer 1" },
	{ 2637, "Timer 2" },
	...
	{ 4348, "Rated cos φ PFMinQ1Rtg" },
	{ 4349, "Rated cos φ PFMinQ2Rtg" },
	{ 4350, "Rated cos φ PFMinQ3Rtg" },
	{ 4351, "Rated cos φ PFMinQ4Rtg" },
	...
	{ 4367, "Nominal cos φ PFMinQ1" },
	{ 4368, "Nominal cos φ PFMinQ2" },
	{ 4369, "Nominal cos φ PFMinQ3" },
	{ 4370, "Nominal cos φ PFMinQ4" },
	{ 4371, "Update of PV module electronics not successful" },
	{ 4372, "PV module logger" },
	{ 4373, "cos φ nominal value in case of active power output" },
	{ 4374, "Excitation type in case of active power output" },
	{ 4375, "cos φ nominal value in case of active power draw" },
	{ 4376, "Excitation type in case of active power draw" },
	{ 4377, "Fallback value of cos φ in case of active power output" },
	{ 4378, "Fallback value of excitation type in case of active power output" },
	{ 4379, "Fallback value of cos φ in case of active power draw" },
	...
	{ 4385, "Advanced settings for cos φ setpoint specifications" },
	...
	{ 4512, "Voltage-dependent reactive power adjustment P(U)" },
	{ 4513, "cos φ(P) charac. curve" },
	{ 4514, "Voltage value" },
	...
	{ 4579, "Current cos φ setpoint for active power draw" },
	...
	{ 4625, "Power factor cos φ, manual setpoint specification" },
	{ 4626, "Power factor cos φ, analogue input" },
	{ 4627, "Power factor cos φ, Modbus" },
	...
	{ 4784, "Parameter change via Sunny Portal" },
	...
	{ 4791, "StrTmLoc" },
	{ 4792, "StrPvFeedTmLoc" },
	{ 4793, "StopPvFeedTmLoc" },
	{ 4794, "Operation with meter at point of interconnection" },
	{ 4795, "Panasonic" },
	{ 4796, "Set active power limit for grid-supplied power at point of interconnection" },
	{ 4797, "Available power for charging stations" },
	{ 4798, "Current power limitation of charging stations" },
	...
	{ 4828, "HzFilTmEna" },
	{ 4829, "HzFilTms" },
	{ 4830, "electric vehicle connected to charging station" },
	{ 4831, "electric vehicle disconnected from charging station" },
	{ 4832, "EvtChrgStpByCar" },
	{ 4833, "Percent" },
	{ 4834, "CosPhi" },
	{ 4835, "GI1" },
	{ 4836, "GO1" },
	...
	{ 4881, "WCtlDctMrk" },
	{ 4882, "ProfileName" },
	{ 4883, "RPRIstTstEnMtrNOK" },
	{ 4884, "RPRIstTstEnMtrOK" },
	{ 4885, "RPRStt" },
	{ 4886, "WdDir" },
	{ 4887, "Radiation standard deviation" },
	{ 4888, "Soiling ratio sensor 1" },
	{ 4889, "Transmission loss sensor 1" },
	{ 4890, "Soiling ratio sensor 2" },
	{ 4891, "Transmission loss sensor 2" },
	{ 4892, "Datamodel version" },
	{ 4893, "Tilt X direction" },
	{ 4894, "Tilt Y direction" },
	...
	{ 7567, "[AE] DEWA 2016 intern" },
	{ 7568, "[AE] DEWA 2016 extern" },
	{ 7569, "[AT] TOR D4 2016" },
	{ 7570, "[US] IEEE 1547" },
	{ 7571, "[US] CA Rule 21" },
	...
	{ 7614, "[AT] TOR Erzeuger Typ A V1.0:2019 Anlage ≤3,68 kVA" },
	{ 7615, "[AT] TOR Generator Type A V1.0:2019" },
	{ 7616, "[AT] TOR Generator Type B V1.0:2019 System >250 kW" },
	...
	{ 8563, "ObjLogPcbTmp" },
	{ 8564, "ObjLogBatVolAv" },
	{ 8565, "ObjLogBatVolMax" },
	{ 8566, "ObjLogBatVolMin" },
	{ 8567, "ObjLogBatAmp" },
	{ 8568, "ObjLogBatTmpAv" },
	{ 8569, "ObjLogBatTmpMax" },
	{ 8570, "ObjLogBatTmpMin" },
	{ 8571, "ObjLogBatCapac" },
	...
	{ 8596, "ObjLogBatChrgDy" },
	{ 8597, "ObjLogBatDschDy" },
	...
	{ 9339, "Sunny Tripower CORE1-US" },
	{ 9340, "Sunny Tripower CORE1-JP" },
	{ 9341, "Edimax Smart Plug 2101W" },
	{ 9342, "Edimax Smart Plug 2110W" },
	...
	{ 9349, "Sunny Tripower 4.0" },
	{ 9350, "Sunny Tripower 5.0" },
	{ 9351, "Sunny Tripower 6.0" },
	{ 9352, "Sunny Tripower 8.0" },
	{ 9353, "Sunny Tripower 10.0" },
	{ 9354, "Sunny Tripower 24.5" },
	{ 9355, "Sunny Tripower 20.0" },
	{ 9356, "Sunny Boy Storage 3.7" },
	{ 9357, "gelöscht" },
	{ 9358, "Sunny Boy Storage 5.0" },
	{ 9359, "Sunny Boy Storage 6.0" },
	{ 9360, "Sunny Boy Storage 3.8 US" },
	{ 9361, "Sunny Boy Storage 5.0 US" },
	{ 9362, "Sunny Boy Storage 6.0 US" },
	{ 9363, "Sunny Boy Storage 4.0 JP" },
	{ 9364, "Sunny Boy Storage 5.0 JP" },
	{ 9365, "Edimax Smart Plug 2101W V2" },
	{ 9366, "Sunny Tripower 3.0" },
	{ 9367, "Sunny Tripower 3.0" },
	{ 9368, "TS4-M" },
	{ 9369, "TS4-S" },
	{ 9370, "TS4-O" },
	{ 9371, "TS4-L" },
	...
	{ 9474, "Sunny Island 4.4M" },
	{ 9475, "Sunny Island 6.0H" },
	{ 9476, "Sunny Island 8.0H" },
	{ 9477, "SHP 143-JP-20" },
	{ 9478, "FRITZ!DECT 200" },
	{ 9479, "FRITZ!DECT 210" },
	...
	{ 10455, "cos φ setpoint, cos φ config., direct specif." },
	{ 10456, "cos φ excit.type, cos φ config., direct spec." },
	{ 10457, "Excit. type at start point, cos φ(P) char. conf." },
	{ 10458, "cos φ at start point, cos φ(P) char. config." },
	{ 10459, "Active power starting point" },
	{ 10460, "Excit. type at end point, cos φ(P) char. config." },
	{ 10461, "cos φ at end point, cos φ(P) char. config." },
	...
	{ 10587, "External cos φ setpoint specification, cos φ setpoint for active power output" },
	{ 10588, "External cos φ setpoint specification, excitation type for active power output" },
	...
	{ 10655, "Act. power at start point, cos φ(P) char. config." },
	{ 10656, "Act. power at end point, cos φ(P) char. config." },
	...
	{ 10711, "Excitation type of cos φ" },
	...
	{ 10939, "Increased self-consumption switched on" },
	...
	{ 10978, "P(f), lag time" },
	{ 10979, "Activating voltage, cos φ(P) char. conf." },
	{ 10980, "Deactivating voltage, cos φ(P) char. conf." },
	...
	{ 11026, "Inverter.VArModCfg.VArAct" },
	...
	{ 11285, "cos φ of start pt, cos φ(P) char. curve config" },
	{ 11286, "cos φ of end pt, cos φ(P) char. curve config" },
	...
	{ 11303, "External cos φ setting, fallback behavior" },
	{ 11304, "External cos φ setting, timeout" },
	{ 11305, "External cos φ setpoint specification, fallback value of cos φ for active power output" },
	{ 11306, "External cos φ setpoint specification, fallback value of the excitation type for active power output" },
	{ 11307, "Current spec. active power limitation P" },
	{ 11308, "Current spec. reactive power Q" },
	{ 11309, "Current spec. cos φ" },
	{ 11310, "Current spec. stimulation type cos φ" },
	...
	{ 11383, "End time range for generator request" },
	...
	{ 11446, "Limit battery state of charge generator start in add time range" },
	{ 11447, "Limit battery state of charge generator stop in add time range" },
	...
	{ 11464, "Inverter.DctMrk.VArModCfg.PFCtlComCfg.PF" },
	{ 11465, "Inverter.DctMrk.VArModCfg.PFCtlComCfg.PFExt" },
	...
	{ 11680, "Y value 1 of characteristic curve of analogue input" },
	{ 11681, "Sig. val. 2 of char. curve of analogue input" },
	{ 11682, "Y value 2 of characteristic curve of analogue input" },
	...
	{ 11726, "Inverter.WModCfg.WCtlComCfg.W.phsA" },
	{ 11727, "Inverter.WModCfg.WCtlComCfg.W.phsB" },
	{ 11728, "Inverter.WModCfg.WCtlComCfg.W.phsC" },
	{ 11729, "Inverter.VArModCfg.VArCtlComCfg.VArSpt.phsA" },
	{ 11730, "Inverter.VArModCfg.VArCtlComCfg.VArSpt.phsB" },
	{ 11731, "Inverter.VArModCfg.VArCtlComCfg.VArSpt.phsC" },
	...
	{ 11737, "Setpoint for active power limitation via digital input" },
	...
	{ 12188, "Rated cos φ PFMinQ1Rtg" },
	{ 12189, "Rated cos φ PFMinQ2Rtg" },
	{ 12190, "Rated cos φ PFMinQ3Rtg" },
	{ 12191, "Rated cos φ PFMinQ4Rtg" },
	...
	{ 12208, "Nominal cos φ PFMinQ1" },
	{ 12209, "Nominal cos φ PFMinQ2" },
	{ 12210, "Nominal cos φ PFMinQ3" },
	{ 12211, "Nominal cos φ PFMinQ4" },
	...
	{ 12215, "External cos φ setting, cos φ nominal value in case of active power output" },
	{ 12216, "External cos φ setting, excitation type in case of active power output" },
	{ 12217, "External cos φ setting, cos φ nominal value in case of active power draw" },
	{ 12218, "External cos φ setting, excitation type in case of active power draw" },
	{ 12219, "External cos φ setting, fallback value of cos φ in case of active power output" },
	{ 12220, "External cos φ setting, fallback value of excitation type in case of active power output" },
	{ 12221, "External cos φ setting, fallback value of cos φ in case of active power draw" },
	{ 12222, "External cos φ setting, fallback value of excitation type in case of active power draw" },
	{ 12223, "Manual cos φ setting, cos φ nominal value in case of active power generation" },
	{ 12224, "Manual cos φ setting, excitation type in case of active power generation" },
	{ 12225, "Manual cos φ setting, cos φ nominal value in case of active power draw" },
	{ 12226, "Manual cos φ setting, excitation type in case of active power draw" },
	{ 12227, "cos φ setting, actual value filter for active power value" },
	{ 12228, "cos φ setting, actual value filter for active power value" },
	{ 12229, "cos φ setting, nominal value filter" },
	{ 12230, "cos φ setting, setting time, nominal value filter" },
	{ 12231, "cos φ setting, limitation of change rate" },
	{ 12232, "cos φ setting, increase rate" },
	...
	{ 12258, "cos φ setting, decrease rate" },
	...
	{ 12335, "cos φ(P), upper deactivation voltage" },
	{ 12336, "cos φ(P), upper activation voltage" },
	{ 12337, "cos φ(P), max. number of support points" },
	{ 12338, "cos φ(P), number of support points to be used" },
	{ 12339, "cos φ(P), excitation type" },
	{ 12340, "cos φ(P), cos φ nominal value" },
	{ 12341, "cos φ(P), active power" },
	...
	{ 12346, "cos φ(P), actual value filter for active power measured value" },
	{ 12347, "cos φ(P), setting time, actual value filter" },
	{ 12348, "cos φ(P), nominal value filter" },
	{ 12349, "cos φ(P), setting time, nominal value filter" },
	{ 12350, "cos φ(P), limitation of change rate" },
	{ 12351, "cos φ(P), increase rate" },
	{ 12352, "cos φ(P), decrease rate" },
	...
	{ 12366, "cos φ(U), max. number of support points" },
	{ 12367, "cos φ(U), number of support points used" },
	{ 12368, "cos φ(U), voltage value" },
	{ 12369, "cos φ(U), excitation type" },
	{ 12370, "cos φ(U), cos φ nominal value" },
	{ 12371, "cos φ(U), actual value filter for active power measured value" },
	{ 12372, "cos φ(U), setting time, actual value filter" },
	{ 12373, "cos φ(U), nominal value filter" },
	{ 12374, "cos φ(P), setting time, nominal value filter" },
	{ 12375, "cos φ(P), limitation of change rate" },
	{ 12376, "cos φ(U), increase rate" },
	{ 12377, "cos φ(U), decrease rate" },
	{ 12378, "cos φ(U), tripping delay" },
	{ 12379, "cos φ(U), status" },
	{ 12380, "JET test mode" },
	...
	{ 12407, "Displacement factor cos φ setpoint input via analog input" },
	{ 12408, "Displacement factor cos φ excitation type via analog input" },
	...
	{ 12424, "Current cos φ setpoint for active power draw" },
	{ 12425, "Current cos φ excitation type setpoint for active power draw" },
	...
	{ 12433, "cos φ(P), lower deactivation voltage" },
	{ 12434, "cos φ(P), lower activation voltage" },
	...
	{ 12451, "Excitation type of cos φ" },
	...
	{ 12516, "SUSyID of the charge controller" },
	...
	{ 12578, "Parameter change via Sunny Portal" },
	...
	{ 12625, "Dummy.ObjLogTotCsmp" },
	{ 12626, "Dummy.ObjLogSelfCsmp" },
	{ 12627, "Dummy.ObjLogDirCsmp" },
	{ 12628, "External cos φ setting, cos φ nominal value in case of active power output" },
	{ 12629, "External cos φ setting, excitation type in case of active power output" },
	{ 12630, "External cos φ setting, cos φ nominal value in case of active power draw" },
	{ 12631, "External cos φ setting, excitation type in case of active power draw" },
	...
	{ 12635, "Energy released by string |s0|" },
	{ 12636, "Total energy released by string |s0|" },
	{ 12637, "Set offset of energy released by string |s0|" },
	...
	{ 12643, "InOut.DigIn" },
	{ 12644, "DcCfg.VolMax" },
	{ 12645, "Inverter.WCtlHzModCfg.HzFilTmEna" },
	{ 12646, "Inverter.WCtlHzModCfg.HzFilTms" },
	{ 12647, "Bat.TmpValMax" },
	{ 12648, "Bat.TmpValMin" },
	{ 12649, "Bat.ChaVolSptDmd" },
	{ 12650, "Bat.DschVolSptDmd" },
	{ 12651, "Bat.ChaAmpSptDmd" },
	{ 12652, "Bat.DschAmpSptDmd" },
	{ 12653, "Bat.ChakWhStt" },
	{ 12654, "Bat.CelVolSum" },
	{ 12655, "Bat.CelVolMin" },
	{ 12656, "Bat.CelVolMax" },
	{ 12657, "InOut.PFValOut" },
	{ 12658, "Env.DewPtTmp" },
	{ 12659, "Env.AirPresAbs" },
	{ 12660, "Env.AirPresRel" },
	{ 12661, "Env.WdSpdDv" },
	{ 12662, "Env.WdDirDv" },
	{ 12663, "Env.WdMsQual" },
	{ 12664, "Env.PrecipRteAbs" },
	{ 12665, "Env.PrecipRteDif" },
	{ 12666, "Env.PrecipInts" },
	{ 12667, "Env.PrecipTyp" },
	{ 12668, "Env.WMOCode" },
	{ 12669, "Env.LgtEvt" },
	{ 12670, "Env.LgtEvtIntv" },
	{ 12671, "Env.ExSnsTmp" },
	{ 12672, "Operation.Vol" },
	{ 12673, "PCC.RPRChk" },
	{ 12674, "PCC.RPRWPrc" },
	{ 12675, "PCC.RPRChkTms" },
	{ 12676, "Inverter.WModCfg.WCnstCfg.WNomEna" },
	{ 12677, "Inverter.WModCfg.WCnstCfg.WEna" },
	{ 12678, "Inverter.WModCfg.WCtlComCfg.Ena" },
	{ 12679, "Inverter.WModCfg.WCtlComCfg2.Ena" },
	{ 12680, "Inverter.CtlComCfg.WCtlDctMrk.SmaSpotEna" },
	{ 12681, "Inverter.CtlComCfg.WCtlDctMrk.MbEna" },
	{ 12682, "Inverter.CtlComCfg.WCtlEvu.AnInEna" },
	{ 12683, "Inverter.CtlComCfg.WCtlEvu.DigInEna" },
	{ 12684, "Inverter.CtlComCfg.WCtlEvu.MbEna" },
	{ 12685, "Inverter.CtlComCfg.VArCtlEvu.DigInEna" },
	{ 12686, "Inverter.CtlComCfg.VArCtlEvu.AnInEna" },
	{ 12687, "Inverter.CtlComCfg.VArCtlEvu.MbEna" },
	{ 12688, "Inverter.CtlComCfg.PFCtlEvu.MbEna" },
	{ 12689, "Inverter.CtlComCfg.PFCtlEvu.AnInEna" },
	{ 12690, "Mobus TCP server address" },
	{ 12691, "Modbus profile" },
	{ 12692, "PCC.RPRStt" },
	{ 12693, "Env.WdDir" },
	{ 12694, "Device temperature" },
	{ 12695, "Radiation standard deviation" },
	{ 12696, "Soiling ratio sensor 1" },
	{ 12697, "Transmission loss sensor 1" },
	{ 12698, "Soiling ratio sensor 2" },
	{ 12699, "Transmission loss sensor 2" },
	{ 12700, "Datamodel version" },
	{ 12701, "Software version" },
	{ 12702, "Hardware version" },
	{ 12703, "Tilt X direction" },
	{ 12704, "Tilt Y direction" },
	{ 12705, "Factory calibration year" },
	{ 12706, "Factory calibration month" },
	{ 12707, "Factory calibration day" },
	...
	{ 30012, "cos φ specification" },
	{ 30013, "Reactive power/active power char. curve Q(P)" },
	{ 30014, "React. power/volt. char. Q(V)" },
	{ 30015, "cos φ / reactive power char. curve cos φ(P)" },
	{ 30016, "cos φ / voltage curve cos φ(U)" },
	{ 30017, "Unbalances" },
	...
	{ 200058, "Contact to device '{{0}}' with serial number {{1}} is overdue, last contact: {{2}}" },
	...
	{ 200062, "Reminder: Contact to device '{{0}}' with serial number {{1}} is still present, last contact: {{2}}" },
	...
	{ 200136, "Displacement factor cos φ setpoint input via analog input" },
	{ 200137, "Displacement factor cos φ excitation type via analog input" },
...
typedef struct _sma_string sma_string_t;

char *getsmastring(int tag) {
	register sma_string_t *s;

	dprintf(5,"tag: %d\n", tag);

	for(s=sma_strings; s->tag; s++) {
//		dprintf(8,"s->tag: %d, tag: %d\n", s->tag, tag);
		if (s->tag == tag) {
			dprintf(5,"found\n");
			return s->string;
		}
	}
	log_error("TAG NOT FOUND: %d\n", tag);
	dprintf(5,"NOT found\n");
	return 0;
}
