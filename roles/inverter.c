...
static int inverter_config(void *h, int req, ...) {
	inverter_session_t *s = h;
	va_list ap;
	int r;
...
solard_driver_t inverter_driver = {
	SOLARD_DRIVER_ROLE,
	"Inverter",
	(solard_driver_new_t)inverter_new,		/* New */
	(solard_driver_open_t)inverter_open,		/* Open */
	(solard_driver_close_t)inverter_close,		/* Close */
	(solard_driver_read_t)inverter_read,		/* Read */
	(solard_driver_write_t)inverter_write,		/* Write */
	(solard_driver_config_t)inverter_config,	/* Config */
};
